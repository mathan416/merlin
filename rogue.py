# rogue.py — Merlin Rogue (Merlin Launcher Compatible, Low-Mem, Scrolling Camera)
# CircuitPython 9.x / Adafruit MacroPad RP2040 (128×64 mono OLED)
# Written by Iain Bennett — 2025
#
# Exposes: class `rogue` with .group, .new_game(), .tick(), .button(key, pressed=True), .button_up(key), .cleanup()
#
...
class rogue:
    ...
    def _draw_menu(self):
        ...
        if HAVE_LABEL:
            ...
            self._set_label(self._lbl1, "Merlin Rogue", 64, 38, scale=1, anchor=(0.5,0))
